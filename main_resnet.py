...
def save_checkpoint(state, filename='./data/checkpoint-reset.pth.tar'):
...
def start():
    ...
    data_normalization_tuple = ((0.5071, 0.4867, 0.4408), (0.2675, 0.2565, 0.2761))
    ...
    # Wandb initialize
    wandb.init(project="csci646-assignment-1", name="resnet34")
    ...
    for epoch in range(total_epoch):
        ...
        # Log in W&B
        wandb.log({"epoch": epoch+1, "train_accuracy": train_accuracy, "train_loss": train_loss, "val_accuracy": val_accuracy, "val_loss": val_loss, "learning_rate": current_lr})
